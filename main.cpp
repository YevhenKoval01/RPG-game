...
public:
    ...
    Player() {
        ...
        if (!font.loadFromFile("determination-extended\\determination-extended.ttf")) {
    ...
    void loadTextures() {
        loadAnimation("left", "Animations\\Left_", {1, 0, 1, 2});
        loadAnimation("right", "Animations\\Right_", {1, 0, 1, 2});
        loadAnimation("up", "Animations\\Up_", {1, 2});
        loadAnimation("down", "Animations\\Down_", {1, 2});

        loadDefaultTexture("left", "Animations\\Left_2.png");
        loadDefaultTexture("right", "Animations\\Right_2.png");
        loadDefaultTexture("up", "Animations\\Up_1.png");
        loadDefaultTexture("down", "Animations\\Down_1.png");
    }
...
void startBattle(sf::RenderWindow& window,const int&monstrMaxHp,int& monstrCurrentHp) {
    ...
    if (!heartTexture.loadFromFile("Animations\\serce6.PNG")) {
...
void battleWindow(sf::RenderWindow& window) {
    ...
    sf::Sprite monstrSp;
    if(monstrTexture.loadFromFile("Monstr"+std::to_string(std::rand()%2+1)+".png")){
...
auto main()->int {
    ...
    // Tworzenie hitboxów
    locations["Loc1"] = Location("locations\\Home.png", {90, 550});
    locations["Loc2"] = Location("locations\\Ulica.png", {10, 850});
    locations["Loc3"] = Location("locations\\Loc3.png", {450, 350});
    locations["Loc4"] = Location("locations\\Loc4.png", {30, 350});
    locations["Loc5"] = Location("locations\\Loc5.png", {50, 350});
